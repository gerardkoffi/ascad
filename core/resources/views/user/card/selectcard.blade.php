                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="post" action="{{route('card.view', $cad->id)}}">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <h4 class="text-success">Quantité disponible {{\App\card::where('sub_category_id', $cad->id)->where('user_id',0)->count()}}</h4>
                                                        <br>
                                                        <div class="form-group">
                                                            <strong class="col-md-12">Votre quantité d'achat</strong>
