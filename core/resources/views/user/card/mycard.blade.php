                                            ...
                                            <div class="panel-body">
                                                <table class="table table-bordered table-hover">
                                                  ...
                                                  <tr class="text-center">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer" >
                                                                            ...
                                                                            @else
                                                                                <button type="button" class="btn btn-primary pull-right markused" data-id="{{$tr->id}}">Marquer comme utilisé</button>
                                                                            @endif --}}
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="4"><h3 style="text-align: center">Désolé ! Pour l'instant vous n'avez pas de carte.</h3></td>
                                                        </tr>
                                                    @endif
                                                    </tbody>
                                                </table>
