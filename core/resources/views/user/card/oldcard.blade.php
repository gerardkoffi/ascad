            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-page-content-inner"><!-- about page content inner -->
                        <h2 class="title">Mon historique de cartes utilisées</h2>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    @if(count($usercard) > 0)
                                                        @foreach($usercard as $tr)
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-info btn-sm btn-block dtlsviebtn" data-toggle="modal"  data-target="#dtlsviebtnnn{{$tr->id}}" data-id="{{$tr->id}}" data-details="{{$tr->card->card_details}}" data-image="{{asset($tr->card->card_image)}}">Afficher</button>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer" >
                                                                            ...
                                                                            @if($tr->status == 0)
                                                                                <button type="button" class="btn btn-default pull-right " data-id="{{$tr->id}}">Utilisé</button>
                                                                            @else
                                                                                <button type="button" class="btn btn-default pull-right markused" data-id="{{$tr->id}}">Marquer comme utilisé</button>
                                                                            @endif
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="4"><h3 style="text-align: center">Pardon ! Pour l'instant, vous n'avez aucune carte.</h3></td>
                                                        </tr>
                                                    @endif
                                                    </tbody>
                                                </table>
