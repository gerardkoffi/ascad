                    ...
                    <div class="tile">
                        <div class="panel-group">
                            ...
                            <div class="panel panel-default">
                                        ...
                                        <div class="card-body ">
                                            <div class="form-group">
                                                <ul style="margin: 0px; padding: 0px; text-align: center;">
                                                    <li class="list-group-item">Montant: <strong>{{$data->amount}} {{$gnl->cur}}</strong></li>
                                                    <li class="list-group-item">Charger: <strong>{{$data->charge}} {{$gnl->cur}}</strong></li>
                                                    <li class="list-group-item">A payer: <strong>{{$data->charge + $data->amount}} {{$gnl->cur}}</strong></li>
                                ...
                                <div class="form-group" >
                                     <button class="btn btn-info col-md-12" ><i class="fas fa-check-circle"></i> Déposez maintenant</button>
                                </div>
