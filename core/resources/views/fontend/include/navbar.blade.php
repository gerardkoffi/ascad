        ...
        <div class="collapse navbar-collapse" id="mirex">
            ...
            @guest
                ...
                <li class="nav-item active">
                    <a class="nav-link pl-0" href="{{route('user.index')}}">Acceuil</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link pl-0" href="{{route('login')}}">Se connecter</a>
                </li>
               {{--  <li class="nav-item">
                    <a class="nav-link" href="{{route('user.about')}}">A propos</a>
                </li>
                <li class="nav-item ">
                ...
                <li class="nav-item dropdown ">
                    <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown">Compte</a>
                ...
                @else
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link" href="{{route('user.buycard')}}">Acheter une carte</a>
                    </li> 

                    <li class="nav-item dropdown ">
                        <a class="nav-link dropdown-toggle" href="" data-toggle="dropdown">Ma carte</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('user.mycard')}}">Ma carte</a>
                            <a class="dropdown-item" href="{{route('user.old.card')}}">Carte usagée</a>
                        </div>
                    </li>
                    <li class="nav-item ">
                    ...
                    <li class="nav-item dropdown ">
                        ...
                        <div class="dropdown-menu">
                            {{-- <a class="dropdown-item" href="#"> Solde : {{Auth::user()->balance}} {{$gnl->cur}} </a> --}}
                            <a class="dropdown-item" href="{{route('user.change-password')}}">Changer le mot de passe</a>
