            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <div class="caption">
                            <h2 style="text-align : center;color : white">Section bannière</h2>
                        </div>
                        ...
                        <div class="table-scrollable">
                            <form method="POST" action="{{route('admin.banner.updateppp')}}" enctype="multipart/form-data">
                                ...
                                <div class="form-actions right">
                                    <button type="submit" class="btn btn-success btn-lg btn-block">Mise à jour</button>
                                </div>
                            </form>
                        </div>
                    </div>
