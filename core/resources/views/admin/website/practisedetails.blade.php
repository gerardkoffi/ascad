...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-info">
                        <div class="caption">
                            <h2 style="text-align: center;color: white">Nos caractéristiques</h2>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <div class="tile">
        <div class="card">
            <div class="card-header bg-info">
                <div class="caption">
                    <h2 style="text-align: center; color: white">Nos caractéristiques Détails

                        <a class="btn btn-dark pull-right" data-toggle="modal" data-target="#newfeatures">
                            <i class="fa fa-plus"></i> Nouvelles fonctionnalités
                        </a>
                    </h2>
                </div>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Modifier les fonctionnalités </h4>
                                            ...
                                            <div class="modal-body">
                                                <form role="form" method="POST" action="{{route('admin.pracdetails-update')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <h4>Icône <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/" class="pull-right">Fontawesome Icon</a></h4>
    ...
    <div id="newfeatures" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Nouvelles fonctionnalités</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
